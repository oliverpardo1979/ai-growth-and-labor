...
Paradoxically, when AI efficiency is bounded, permanently faster wage growth requires AI to substitute for labor, not complement it. If attainable efficiency is sufficiently high, substitution allows capital and AI services to expand faster than effective labor. This expansion raises workers’ marginal products: wages grow faster than labor-augmenting technological progress, but output per worker grows even faster, so labor’s income share vanishes. When labor remains a bottleneck, its income share stays positive, but wages and output per worker eventually grow at the rate of labor-augmenting technological progress. Unit elasticity provides an exception if there is no upper bound on AI efficiency: continued efficiency improvements can sustain wage and output-per-worker growth at the same rate, above the exogenous rate, while preserving a positive labor share.
