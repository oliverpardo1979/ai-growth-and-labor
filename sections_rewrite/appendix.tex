...
\[
 ...
 \right]^{(1-\alpha)/\alpha}.
\]
Equation~\eqref{eq:rewrite-capital-return} then gives the net return on
capital in this limit under marginal-cost pricing:
\begin{equation}
...
\end{equation}
The inequality follows by comparison with the monopoly return in
