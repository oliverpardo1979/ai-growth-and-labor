...
Paradoxically, when AI efficiency is bounded, permanently faster wage growth requires AI to substitute for labor, not complement it. With sufficiently high AI efficiency, capital and AI services can then expand faster than effective labor, raising workers’ marginal products. Wages grow faster than labor-augmenting technological progress, but more slowly than output per worker, so labor’s income share vanishes. In the labor-bottleneck regime, by contrast, labor retains a positive income share, but wage and output-per-worker growth eventually return to the exogenous rate. The upper bound matters for this contrast. Without it, continued AI efficiency improvements at unit elasticity can sustain the same growth rate for wages and output per worker, above the exogenous rate, while preserving a constant positive labor share.
...
%Neither market structure nor efficiency alone determines which economy grows faster. 
