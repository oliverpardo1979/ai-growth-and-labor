...
do not compensate for the restriction on AI use. Competition sustains
...
enough to offset the restriction on AI use. With $\alpha=0.33$, monopoly
...
The relevant comparison is not efficiency alone, but whether its
improvement compensates for the restriction on AI use.
