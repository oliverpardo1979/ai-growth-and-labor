...
This is consistent with the household's saving decision.
The Euler equation~\eqref{eq:rewrite-euler} fixes the difference between
the interest rate and consumption-per-person growth at $\rho$, not the
interest rate itself. The permanently higher return therefore supports
permanently faster consumption growth, rather than requiring a restriction
on household saving.
