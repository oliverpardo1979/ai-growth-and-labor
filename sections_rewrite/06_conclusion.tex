...
The numerical simulations show that early output-per-worker growth can remain moderate and similar across economies approaching different long-run regimes. Lower research productivity can delay takeoff in the AI-dominated economy without changing its long-run growth rates. Whether wages ultimately keep pace with output per worker depends on both the production technology and the market conditions governing AI development and use.
