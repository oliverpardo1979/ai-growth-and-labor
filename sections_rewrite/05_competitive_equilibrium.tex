...
At the competitive price $p_X=1/B_0$, final-good firms continue to solve
...
then implies $U=(1-\alpha)s_XY$, since $X=B_0U$.

The household continues to choose consumption and saving according to
...
research, even if the upper bound would permit much higher efficiency.\footnote{The
proof in Appendix~\ref{app:rewrite-proofs} also treats the boundary case
$B_0=\mathcal B^{\mathrm{mc}}(\sigma)$.}
