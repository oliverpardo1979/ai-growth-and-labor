...
At a given efficiency, the monopoly markup restricts the use of AI
services. This lowers the limiting output--capital ratio and therefore
the return on capital. A higher efficiency is then needed for that return
to exceed $\rho+\gamma$. For $\alpha=0.33$, the threshold under
marginal-cost pricing is $33.0\%$ lower than under monopoly pricing.

This comparison does not establish an alternative equilibrium with
privately financed research. Marginal-cost pricing eliminates the
operating profits that make research investment profitable in the model.
I isolate the effect of pricing on the use of a given AI technology,
not the effects of changing market structure on research or welfare.
