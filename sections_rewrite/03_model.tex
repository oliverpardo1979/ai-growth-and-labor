...
I use the CES specification in equation~\eqref{eq:rewrite-ces} to
represent how labor and AI services combine, either within a single
task or as aggregate inputs across multiple tasks. The latter
interpretation connects to \citet{jonestonetti2026}, who show how a
task-based production process can admit a CES-like aggregate
representation.
