...
Monopoly pricing also raises the AI-efficiency threshold needed to sustain
the higher return associated with AI-dominated growth. This creates a
policy tension: monopoly rents reward research, but markups restrict the
use of the technology already developed. Removing those rents after
innovation can undermine the credibility of the incentives offered
beforehand \citep{kydlandprescott1977}. Patent buyouts could instead reward
the developer while opening access to existing AI technology
\citep{kremer1998}. An extension could study how to value and finance such
buyouts while preserving incentives for further RSI. The pricing
comparison identifies a reason to consider these policies, not an optimal
time to end monopoly protection.

Simulations show that early growth can look similar across regimes with different long-run outcomes. The question still remains whether human labor will be essential enough for wages to keep pace with the rest of the economy.
