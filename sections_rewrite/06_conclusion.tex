...
This paper endogenizes investment in AI research, which in turn affects the pace of economic growth. Even under RSI, computing requires resources that compete with consumption and accumulation of physical capital. Algorithms and model weights, by contrast, are non-rival: their use in one computation does not reduce their availability for others. Following \citet{romer1990}, I use monopoly rents to make research investment profitable.

With an upper bound on AI efficiency, permanently faster wage growth requires sufficient substitution between AI and labor and sufficiently high attainable efficiency. Substitution allows capital and AI services to expand faster than effective labor, raising workers' marginal products even as labor's share vanishes. In the labor-bottleneck equilibria, labor retains a positive income share, but wage and output-per-worker growth eventually return to the exogenous rate of labor-augmenting technological progress. Preserving a positive labor share and sustaining faster wage growth are therefore different outcomes. The upper bound on AI efficiency matters for this contrast: without it, the unit-elasticity case can sustain both output and wages growth rates above this exogenous rate while preserving a positive labor share.

The representative
household owns both physical capital and the AI developer. I therefore
characterize the division of income among wages, capital income, and
developer profit, not the effects of unequal asset ownership across households.
AI-dominated growth can permanently increase the return on capital,
raising questions about wealth concentration not examined here
\citep{bergbuffiezanna2018,mollrachelrestrepo2022}. 

RSI is not sufficient for permanently faster output-per-worker growth, nor does such growth require continuing improvements in AI efficiency. Under complementarity, output-per-worker growth cannot permanently exceed the rate of labor-augmenting technological progress, even without an upper bound on AI efficiency. With
...
AI-dominated growth without monopoly or further research. The simulations
show that, from an initial efficiency too low to sustain AI-dominated growth
under competition, monopoly rents can finance improvements that allow
an escape from the labor bottleneck. But markups restrict AI use and
raise the efficiency required for AI-dominated growth relative to marginal-cost pricing.
...
long-run growth only if its efficiency gains offset the reduction in AI
use caused by its markup.
Neither market structure nor efficiency alone determines which economy
grows faster. 

The monopoly is an institutional assumption, not a consequence of RSI.
In practice, firms compete to develop algorithms and train models. However, as
...
My comparison between monopoly and competition raises the question of how to
reward AI research without restricting the use of the technology it produces.
Monopoly rents encourage research, but monopoly pricing can leave the economy
labor-bottlenecked even when competition would sustain AI-dominated growth.
Removing those rents after innovation, however, can undermine incentives to
invest beforehand. Patent buyouts could address this tension by compensating
the developer for opening access to existing AI technology \citep{kremer1998}.
An extension could study how to value and finance such buyouts while preserving
incentives for further RSI.

The numerical simulations show that early output-per-worker growth can remain moderate and similar across economies approaching different long-run regimes. Lower research productivity can delay takeoff in the AI-dominated economy without changing its long-run growth rates. The question remains whether human labor will be essential enough for wages to keep pace with output per worker. The answer depends on both technology and the market conditions governing AI development and use.
