...
For the comparisons in Section~\ref{sec:rewrite-quantitative},
...
I use the collocation solver \texttt{scipy.integrate.solve\_bvp}, provided
by the open-source Python library SciPy \citep{virtanenetal2020}, with
