...
With an upper bound on AI efficiency, permanently faster wage growth requires sufficient substitution between AI and labor and sufficiently high attainable efficiency. Substitution allows capital and AI services to expand faster than effective labor, raising workers' marginal products even as labor's share vanishes. At any finite elasticity above one, wages receive a positive fraction of the additional output-per-worker growth; output and AI revenue per worker nevertheless grow faster than wages. In the complementary labor-bottleneck equilibria, labor retains a positive income share, but wage and output-per-worker growth return to the exogenous rate of labor-augmenting technological progress. Preserving a positive labor share and sustaining faster wage growth are therefore different outcomes. The upper bound on AI efficiency matters for this contrast: without it, the unit-elasticity case can sustain both growth rates above this exogenous rate while preserving a positive labor share.
...
\citep{bergbuffiezanna2018,mollrachelrestrepo2022}. The representative
...
The numerical simulations show that early output-per-worker growth can remain moderate and similar across economies approaching different long-run regimes. Research productivity affects both the initial allocation of resources and the subsequent timing of growth: lower productivity can delay takeoff in the AI-dominated economy without changing its long-run growth rates.
