...
Complementarity suffices to bound long-run growth despite RSI and no bound on AI efficiency.
...
Inference and research compute vanish as shares of output. The AI industry nevertheless retains a positive revenue share.
...
\begin{equation}
 0<\eta<\alpha,\qquad
 (1-\alpha)\omega_X\leq\tfrac12,\qquad \eta+\omega_X<1.
...
worker. This contrasts with the finite-upper-bound regimes in
