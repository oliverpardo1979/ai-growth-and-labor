...
I model labor and AI services as aggregate inputs, not as alternative ways of
performing a single task. \citet{jonestonetti2026} show how a production process
...
\citet{zeira1998} distinguishes the availability of a labor-saving
technology from its profitable adoption: saving labor may require more
capital. Here, firms choose how much AI to use at given input prices,
rather than whether to adopt a discrete production technique.
...
\citet{liuwan2026} show that a higher markup on general-purpose AI
services can strengthen the supplier's research incentive while raising
research costs for developers of specialized applications. I abstract
from this conflict between AI firms by assuming a single integrated
developer.
...
second is the research-productivity gain from RSI. With a finite upper bound, the third
