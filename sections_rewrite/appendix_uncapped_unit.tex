...
trajectory. When $\eta\leq1/2$, the bound $(1-\alpha)\omega_X\leq1/2$
makes operating profit concave in $B$, and the RSI technology is jointly
concave in $B,M$. When $\eta>1/2$, the proof instead uses the state
$S=B^{1-\eta}$. The restrictions $\eta<\alpha$ and $\eta+\omega_X<1$
then ensure concavity in the transformed problem. Thus $\eta<\alpha$
supports this second verification argument, although the BGP growth
identities do not require it separately. None of these concavity tests is
asserted to be necessary for equilibrium existence. Finally, $\rho>n$ makes both
...
With any finite upper bound, the unit-elastic equilibria in
...
$\gamma$ and a vanishing labor share across the regimes with a finite upper bound
