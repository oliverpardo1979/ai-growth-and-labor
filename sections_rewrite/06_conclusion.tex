...
show that, from a lower initial efficiency, monopoly rents can finance improvements that allow
...
The illustrative simulations show that early output-per-worker growth can look similar across economies approaching different long-run regimes. Their magnitudes and dates depend on research productivity and other AI-specific parameters that are not jointly estimated from data. I therefore emphasize the conditional mechanisms and long-run results rather than predicted takeoff dates. Whether wages keep pace with output per worker depends on both the production technology and the market conditions governing AI development and use.
