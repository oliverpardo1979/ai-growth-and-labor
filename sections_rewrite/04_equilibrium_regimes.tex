...
A finite upper bound restricts AI efficiency, but not the compute used to supply AI production services. To identify the return when labor's income share vanishes, fix $B>0$ and consider $s_X\to1$. Since $wL/Y=(1-\alpha)(1-s_X)$, this is the zero-labor-share limit.
...
have an antecedent in \citet[Section~9.2.2]{aghionjonesjones2019}, who give
an example in which automation approaches completeness while growth
stabilizes and labor retains a positive income share. In my model, even
autonomous AI research need not eliminate the production bottleneck.
...
output--capital ratio even as $B$ approaches the finite upper bound.
...
AI-efficiency gains vanish. A related mechanism appears in
\citet{restrepo2025agi}: once all bottleneck tasks can be automated,
expanding compute can sustain growth without further technological progress.
...
\citet{acemoglurestrepo2018} and
\citet{autorkausik2026}; \citet{raymookherjee2022} show that the share
can vanish even as wages rise indefinitely.
