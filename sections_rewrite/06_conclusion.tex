...
Monopoly is not necessary to sustain AI-dominated growth, but research
incentives matter for reaching it from a low initial efficiency.
Under free access to the technology and its improvements, competitive
suppliers do not finance RSI: an economy below the competitive efficiency
threshold cannot reach this growth regime through its own research.
Monopoly rents can finance improvements from a low initial efficiency,
but markups restrict AI use and raise the efficiency required for
AI-dominated growth. Removing those rents after innovation
