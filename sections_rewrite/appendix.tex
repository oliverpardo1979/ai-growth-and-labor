...
equation~\eqref{eq:rewrite-marginal-cost-return}. Since
$0<1-\alpha<1$, this return strictly exceeds the monopoly return
in equation~\eqref{eq:rewrite-ai-terminal-ratio}.
