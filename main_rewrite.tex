...
\title{Recursive AI Self-Improvement, Market Power, and Growth}
...
% Previous abstract, preserved before adding the competitive-equilibrium comparison (2026-09-24).
% \begin{abstract}
...
% Previous abstract, preserved before the author's final approval (2026-09-24).
% \begin{abstract}
% I develop an endogenous-growth model in which a monopolistic AI developer
% supplies AI services and invests in recursive AI self-improvement (RSI).
% Under an upper bound on AI efficiency, I characterize two long-run regimes.
% In the labor-bottleneck regime, output per worker and wages eventually grow
% at the exogenous rate of labor-augmenting technological progress.
% With sufficient substitution between AI and labor and a sufficiently high upper bound, the
% AI-dominated regime sustains faster wage growth and a higher long-run return
% to capital. Output per worker outpaces wages, so labor's income share
% vanishes while AI-industry revenue rises as a share of output.
% Under competitive AI supply with freely available models, private
% incentives for RSI disappear and AI efficiency remains fixed. Nevertheless,
% sufficiently high initial efficiency can sustain AI-dominated growth
% through capital accumulation and expanding AI use.
% Monopoly-financed research can enable AI-dominated growth, but markups
% can also leave the economy labor-bottlenecked where competition would
% sustain faster growth with less efficient AI. Numerical simulations show that early
% output-per-worker growth can remain moderate and similar across economies
% approaching different long-run regimes.
% \end{abstract}

% Author-approved abstract, locked in on 2026-09-24.
% Revise only at the author's explicit request.
\begin{abstract}
I develop an endogenous-growth model in which a monopolistic AI developer
supplies AI services and invests in recursive AI self-improvement.
I characterize two long-run regimes under an upper bound on AI
efficiency---the quantity of AI services produced per unit of compute.
Complementarity between AI and labor, or a sufficiently low upper bound on
AI efficiency, can leave labor as a production bottleneck. In this regime,
output per worker and wages eventually grow
at the exogenous rate of labor-augmenting technological progress.
When AI and labor are substitutes and the upper bound is sufficiently high,
an AI-dominated regime sustains permanently faster wage growth and a higher
long-run return to capital. Output per worker grows faster than wages, so
labor's income share vanishes while AI-industry revenue increases as a share
of output. Replacing monopoly with perfect competition eliminates private
research incentives. Nevertheless, if AI is already sufficiently efficient,
the competitive economy can sustain AI-dominated growth through capital
accumulation and expanding AI use.
By contrast, monopoly rewards research but restricts AI use through its markup.
It may therefore produce more efficient AI yet slower long-run growth than
competition.
Numerical simulations show that early output-per-worker growth can remain
moderate and similar across economies approaching different long-run regimes.
\end{abstract}

\begin{center}
\small
\href{https://oliverpardo1979.github.io/ai-growth-and-labor/}{Digital edition and simulations}
\quad\textbar\quad
\href{https://oliverpardo1979.github.io/ai-growth-and-labor/paper/the-future-of-growth-and-human-labor-under-recursive-ai-self-improvement.pdf}{Latest PDF version}
\end{center}
...
\input{sections_rewrite/05_competitive_equilibrium}
\input{sections_rewrite/05_uncapped_equilibria}
\input{sections_rewrite/08_rsi_design}
\input{sections_rewrite/12_rsi_high_productivity}
\input{sections_rewrite/13_rsi_low_productivity}
\input{sections_rewrite/14_competitive_to_monopoly}
\input{sections_rewrite/15_monopoly_growth_reversal}
...
\input{sections_rewrite/appendix_uncapped_unit}
\input{sections_rewrite/appendix_competitive_transition}
