...
Let $\pi_t(b)$ denote operating profit before research
expenditure, after choosing AI production services optimally
at efficiency $b$, as defined in
equation~\eqref{eq:rewrite-service-choice}.
Let $U_t$ denote the corresponding inference compute
at the candidate efficiency $B_t$.
