\subsection{Monopoly slows growth}
...
preceding exercise: research gains fail to compensate for the restriction on AI use caused by monopoly pricing.
...
The preceding simulations remain separate experiments with different initial states
...
competitive-transition solver and numerical checks.
...
Neither response restores AI-dominated growth: by year 10, output
...
The longer windows show that the loss of AI-dominated growth is not
...
efficiency gains do not compensate for the restriction on AI use caused by monopoly pricing.
...
I use this experiment to illustrate a possible growth reversal, not to predict the
