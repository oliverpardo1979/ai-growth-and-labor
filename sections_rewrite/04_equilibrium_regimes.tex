...
I now ask whether monopoly pricing raises the AI efficiency needed to
sustain a return on capital above $\rho+\gamma$, as required for
AI-dominated growth when $\sigma>1$. I compare the same AI technology
under monopoly pricing and marginal-cost pricing, $p_X=1/B$.
Proposition~\ref{prop:rewrite-monopoly-threshold} shows that monopoly
pricing lowers the return on capital in the limit where labor's income
share vanishes and therefore raises the required efficiency threshold.
