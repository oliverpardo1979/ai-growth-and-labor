...
\citep{hernandezbrown2020,erdilbesiroglu2022}.\footnote{Measures of \emph{effective compute} adjust physical compute for algorithmic improvements \citep{hoetal2024algorithms,jones2026future}. I apply this distinction beyond model training to AI research more broadly. \citet{erdiletal2025gate} similarly distinguish nonrival model weights from recurring inference-compute costs.}
