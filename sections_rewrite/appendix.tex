...
If research expenditure follows a candidate equilibrium's trajectory after
$T$, subsequent operating profits cannot be lower once the initial research
phase leaves AI efficiency above the candidate's level at $T$.
\end{proof}
